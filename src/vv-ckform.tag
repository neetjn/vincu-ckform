<vv-ckform>
  <div class="vv-ckform-wrapper">
    <div class="ck_form_container ck_inline" data-ck-version="7">
      <div class="ck_form ck_vertical_subscription_form">
        <div class="ck_form_content">
          <h3 class="ck_form_title">...para recibir el mejor contenido de reclutamiento y ventas! </h3>
          <div class="ck_description">
            <span class="ck_image">
              <img
                alt="Vincu logo color"
                src="https://s3.amazonaws.com/convertkit/subscription_forms/images/005/185/487/standard/VINCU_Logo_Color.jpg?1523477088"/>
            </span>
            <p>La ... plataforma de reclutamiento en el E1rea comercial, te invita a que recibas el mejor contenido en tu correo.</p>
          </div>
        </div>
        <div class="ck_form_fields">
          ...
          <form id="ck_subscribe_form"
                class="ck_subscribe_form"
                action="https://app.convertkit.com/landing_pages/373703/subscribe"
                data-remote="true">
                <input type="hidden"
                      value=""
                        id="ck_form_options" />
            <input type="hidden" name="id" value="373703" id="landing_page_id" />
            ...
            <div class="ck_control_group ck_first_name_field_group">
              <label class="ck_label" for="ck_firstNameField">Nombre</label>
            ...
            <div class="ck_control_group ck_first_name_field_group">
              <label class="ck_label" for="ck_field_27848_en_qu_rea_trabajas">En qu\E9 \E1rea trabajas?</label>
              <select name="ck_field_27848_en_qu_rea_trabajas"
                      class="ck_field_27848_en_qu_rea_trabajas"
                      id="ck_field_27848_en_qu_rea_trabajas">
                <option value="recursoshumanos">Recursos Humanos</option>
                <option value="gerenciacomercial">Gerencia Comercial</option>
                <option value="candidato">Soy un candidato</option>
              </select>
            </div>
    ...
    <div class="ck_control_group ck_first_name_field_group">
      <label class="ck_label" for="ck_field_27848_en_qu_rea_trabajas">En E1rea trabajas?</label>
      <select name="ck_field_27848_en_qu_rea_trabajas" class="ck_field_27848_en_qu_rea_trabajas" id="ck_field_27848_en_qu_rea_trabajas">
        <option value="recursoshumanos">Recursos Humanos</option>
        <option value="gerenciacomercial">Gerencia Comercial</option>
        <option value="candidato">Soy un candidato</option>
      </select>
